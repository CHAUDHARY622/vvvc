...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://manish:manish62@manish0.bmmjt2t.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Manish0")
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5898561883').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL'))

#ai
AI = is_enabled((environ.get("AI","True")), False)
OPENAI_API = environ.get("OPENAI_API","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")
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+4-9dGK1CmUg1MWFl") #[ without @ ]
